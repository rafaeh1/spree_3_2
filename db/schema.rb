...
ActiveRecord::Schema.define(version: 20170116194422) do
  ...
  create_table "spree_braintree_checkouts", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
